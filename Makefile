...
build:
	mkdir -p temp
	$(C) -I./ptl -c ptl/unwind.c -o temp/unwind.o
	$(C) -I./ptl -c ptl/errno-loc.c -o temp/errno-loc.o
	$(C) -I./ptl -c ptl/syscall.c -o temp/syscall.o
	$(C) -I./ptl -c ptl/memrchr.c -o temp/memrchr.o
	ar rcs temp/libptl.a temp/unwind.o temp/errno-loc.o temp/syscall.o temp/memrchr.o
	...
	$(LINK) temp/boot.o target/i686-unknown-linux-musl/release/libmprog.a temp/libptl.a $(BASIC_LIB_C) -o target/i686-unknown-linux-musl/release/$(PROGRAM_NAME).bin
